...
abstract class CameraActivity : AppCompatActivity(), OnImageAvailableListener, Camera.PreviewCallback {
    ...
    private fun isHardwareLevelSupported(characteristics: CameraCharacteristics, requiredLevel: Int): Boolean {
        ...
        return if (deviceLevel == CameraCharacteristics.INFO_SUPPORTED_HARDWARE_LEVEL_LEGACY) requiredLevel == deviceLevel else requiredLevel <= deviceLevel
