...
object ImageUtils {
     ...
     * @param height The height of the input image.
     */
    private external fun convertYUV420SPToRGB565(input: ByteArray, output: ByteArray, width: Int, height: Int)
     ...
     * @param height The height of the input image.
     */
    private external fun convertARGB8888ToYUV420SP(input: IntArray, output: ByteArray, width: Int, height: Int)
     ...
     * @param height The height of the input image.
     */
    private external fun convertRGB565ToYUV420SP(input: ByteArray, output: ByteArray, width: Int, height: Int)
