...
public class ObjectTracker {
    ...
    public synchronized void drawOverlay(
        ...
        drawNative(cameraViewSize.getWidth(), cameraViewSize.getHeight(), matrixValues);
    }
    ...
    public synchronized void nextFrame(
        ...
        for (final TrackedObject trackedObject : trackedObjects.values()) trackedObject.updateTrackedPosition();
    ...
    private void updateDebugHistory() {
        ...
        synchronized (debugHistory) {
            ...
            while (debugHistory.size() > MAX_DEBUG_HISTORY_SIZE) debugHistory.remove(0);
        }
    }
    ...
    public static class PointChange {
        ...
        public Keypoint getDelta() {
            if (pointDelta == null) pointDelta = keypointB.delta(keypointA);
            return pointDelta;
        }
    }
    ...
    public class TrackedObject {
        ...
        public synchronized RectF getTrackedPositionInPreviewFrame() {
            ...
            if (lastTrackedPosition == null) return null;
        ...
        private void checkValidObject() {
            if (isDead) throw new RuntimeException("TrackedObject already removed from tracking!");
